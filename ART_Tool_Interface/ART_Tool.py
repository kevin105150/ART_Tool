...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Frame1.place(relx=0.083, rely=0.089, relheight=0.833
                , relwidth=0.842)
        ...
        self.TCombobox1.place(relx=0.35, rely=0.133, relheight=0.056
                , relwidth=0.317)
        self.TCombobox1.configure(takefocus="")
        self.TCombobox1['values'] = ['LeNet5', 'CNN', 'AlexNet', 'GoogleNet', 'VGG19', 'ResNext101']
        self.TCombobox1.current(0)

        self.TCombobox2 = ttk.Combobox(self.Frame1)
        self.TCombobox2.place(relx=0.35, rely=0.293, relheight=0.056
                , relwidth=0.317)
        self.TCombobox2.configure(takefocus="")
        self.TCombobox2['values'] = ['LeNet5', 'CNN', 'AlexNet', 'GoogleNet', 'VGG19', 'ResNext101']
        self.TCombobox2.current(0)

        self.TCombobox3 = ttk.Combobox(self.Frame1)
        self.TCombobox3.place(relx=0.35, rely=0.453, relheight=0.056
                , relwidth=0.317)
        self.TCombobox3.configure(takefocus="")
        self.TCombobox3['values'] = ['FGSM', 'BIM', 'PGD', 'C&W L2', 'C&W Linf']
        self.TCombobox3.current(0)

        self.TEntry1 = ttk.Entry(self.Frame1)
        self.TEntry1.place(relx=0.436, rely=0.613, relheight=0.056
                , relwidth=0.23)
        ...
        def action_event():
            attact_para = [self.TCombobox1.get(), self.TCombobox2.get(), self.TCombobox3.get(), self.TEntry1.get(), self.file_path]
        ...
        def select_event():
            ...
            self.file_path = filedialog.askopenfilenames(filetypes=filetypes)
        ...
        self.TButton2.configure(text='''選擇圖片''')

        self.TEntry2 = ttk.Entry(self.Frame1)
        self.TEntry2.place(relx=0.376, rely=0.747, relheight=0.059
                , relwidth=0.289)
